...
# input()
outfileih = "C:/Users/фыы/Desktop/Desk/ih.npy"
outfileho = "C:/Users/фыы/Desktop/Desk/ho.npy"
...
def owntester():
	...
	image1.save("C:/Users/фыы/Desktop/dvares.png")
	img_array = Image.open("C:/Users/фыы/Desktop/dvares.png")
	mt.imshow(img_array, cmap = 'Greys', interpolation = 'None')
	resized_img = img_array.resize((28, 28), Image.ANTIALIAS)
	resized_img.save("C:/Users/фыы/Desktop/dvares.png")
	img_array = scipy.misc.imread("C:/Users/фыы/Desktop/dvares.png", flatten = True)
...
can = tk.Canvas(root, width = 200, height = 200, bg = "grey")
